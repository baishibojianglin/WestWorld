	...
	export default {
		...
		methods: {
			...
			toGame() {
				...
				// 跳转比赛选择页
				uni.navigateTo({
				    url: '/pages/game/join-game?id=' + this.banner.venue_id + '&thumb=' + this.banner.thumb + '&venue_name=' + this.banner.venue_name + '&address=' + this.banner.address //'/pages/game/join-game?id=' + this.banner.venue_id + '&venueData=' + JSON.stringify(this.banner)
				});
			}
		}
	}
