<template>
	<view>
			...
			<view class="uni-flex uni-row" style="-webkit-justify-content: space-between;justify-content: space-between;">
				<view class="text">
					...
					<view class="uni-text-small" v-if="sessionOrderDetail.order_status == 0 || sessionOrderDetail.order_status == 1">
						距比赛开始：
						<uni-count-down :second="sessionOrderDetail.session_start_time" color="red" @timeup="timeup" class="uni-bold" />
					</view>
					<view class="uni-text-small" v-if="sessionOrderDetail.order_status == 2">
						距比赛结束：
						<uni-count-down :second="sessionOrderDetail.session_end_time" color="red" @timeup="timeup" class="uni-bold" />
					</view>
				</view>
				<view class="text">
					<!-- 二维码 -->
		...
		<view class="footer_button" v-if="(sessionOrderDetail.pay_status == 0 || sessionOrderDetail.order_status == 3) && sessionOrderDetail.order_status != 4">
			<uni-card title="" extra="" note="" thumbnail="" :is-full="true" :is-shadow="true">
